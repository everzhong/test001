...
export default {
  ...
  methods: {
    ...
    /** 查询renwu列表 */
    async getList(query) {
      const {rwpcid,jgdm} = this.listConfig
      ...
      try {
        ...
        //   case 'three':
        //     res = await listRenwuthreeHs({...params,...this.gzQueryForm})
        //     break;
        //   case 'six':
        //     params.type=2
        //     params.ischeck=1
        //     res = await listRenwufourHs({...params,...this.bmQueryForm})
        //     break;
        //   default:
        //     break;
        // }
