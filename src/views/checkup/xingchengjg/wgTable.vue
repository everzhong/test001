    ...
    >
      ...
      <el-table-column label="门诊" align="center">
        <el-table-column label="费用" prop="tym" align="center">
          <template slot-scope="scope"><span @click="viewDetail(scope.row,{jslb:'0101',type:1})" style="color:#1B65B9;cursor:pointer;">{{(scope.row.tym*1).toFixed(2)}}</span></template>
        </el-table-column>
      ...
      <el-table-column label="住院" align="center">
        <el-table-column label="费用" prop="bz" align="center">
          <template slot-scope="scope"><span @click="viewDetail(scope.row,{jslb:'0102',type:1})" style="color:#1B65B9;cursor:pointer;">{{(scope.row.bz*1).toFixed(2)}}</span></template>
        </el-table-column>
        <el-table-column label="占比%" align="center">
          <template slot-scope="scope">
      ...
      <el-table-column label="进销存核查" align="center" v-if="showHc">
        <el-table-column label="费用" prop="bz" align="center">
          <template slot-scope="scope"><span @click="viewDetail(scope.row,{ischeck:1,type:2})" style="color:#1B65B9;cursor:pointer;">{{(scope.row.mxsum*1).toFixed(2)}}</span></template>
        </el-table-column>
        <el-table-column label="占比%" align="center">
          <template slot-scope="scope">
